    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Input Data SKA</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form method="POST" action="{{route('tenagaAhli.add')}}" enctype="multipart/form-data" >
          @csrf
          <div class="box-body col-md-6">
            <div class="box-body col-md-12">
            <div class="form-group">
              <label for="nama">Nama</label>
              <input type="text" name="nama" class="form-control" placeholder="Nama Tenaga Ahli">
            </div>
            </div>
            <div class="box-body col-md-12">
            <div class="form-group" >
            ...
            <div class="box-body col-md-4">
              <div class="form-group ">
                ...
                <select class="form-control" name="tingkatan">
                  <option default value="">Pilih Tingkatan</option>
