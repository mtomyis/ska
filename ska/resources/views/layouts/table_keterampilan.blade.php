    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Table Tenaga Keterampilan</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <tbody>
                ...
                <tr class="{{$warnakolom}}">
                    ...
                    @if ((Session::get('user'))->name == 'admin')
                        <a href="{{ url('delete_keterampilan/'.$all->id) }}" class="btn btn-danger btn-xs" role="button">
                        <i class="fa fa-trash-o"></i>
                        </a>
                        <a href="{{ url('edit_keterampilan/'.$all->id) }}" class="btn btn-info btn-xs" role="button">
                    ...
                    @endif
                        ...
                        if( $pembanding != $status){
                          ...
                          $href =  url ('/file_keterampilan/download/'.$all->file);
