...
<style type="text/css">
    ...
    <table style="width: 100%; text-align: justify;" >
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$posisiyangdiusulkan}}</td>
		</tr>
		...
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$namaperusahaan}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$namapersonil}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$namatempatanggallahir}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$pendidikan}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$pendidikannonformal}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$penguasaanbahasaindonesia}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%">{{$penguasaanbahasainggris}}</td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
		<tr>
    ...
    $file = fopen("uploads/csv/" . $filepengalaman, "r");
    $i = 0;
    ...
    <table style="width: 100%; text-align: justify;">
        <tr>
            <td colspan="5">
                ...
                <tr style="page-break-inside:auto;">
                    <td style="width: 4%;">  </td>
                    <td colspan="4"> <strong> Tahun <?= trim($userdata[0]); ?> <!-- Tahun 2018 --> </strong></td>
                </tr>
                <tr>
                    <td style="width: 4%"> </td>
                    ...
                    <td style="width: 4%"> : </td>
                    <td style="width: 47%"> <?= trim($userdata[1]); ?> <!--Nama Proyek--> </td>
                </tr>
                <tr><td style="line-height: 3px;"> </td></tr>
                <tr>
                    <td style="width: 4%"> </td>
                    ...
                    <td style="width: 4%"> : </td>
                    <td style="width: 47%"> <?= trim($userdata[2]); ?> <!-- Kecamatan Banyuwangi --> </td>
                </tr>
                <tr><td style="line-height: 3px;"> </td></tr>
                </table>
            </td>
        ...
        <tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%"> <?= trim($userdata[3]); ?> <!-- Dinas PU Cipta Karya dan Penataan Ruang --></td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
        <tr>
            <td style="width: 4%"> </td>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%"> <?= trim($userdata[4]); ?> <!-- CV. CONCEPT DESIGN ARCHITECT --></td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
        <tr style="page-break-inside:auto;">
        <!-- ini apa -->
			...
			<td style="width: 47%;">
                ...
                $dataahli = App\Riwayat::getPenugasan(''.$posisiyangdiusulkan,''.$jenispengalaman); ?>
                <table style="width: 100%; text-align: justify">
        ...
        <tr>
            ...
            $awal = DateTime::createFromFormat('d/m/Y', trim($userdata[5]))->format('Y-m-d');
            $akhir = DateTime::createFromFormat('d/m/Y', trim($userdata[6]))->format('Y-m-d');
        ...
        <tr>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%"> {{$posisiyangdiusulkan}} <!-- Ahli Geohidrologi --> </td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
        <tr>
            <td style="width: 4%"> </td>
			...
			<td style="width: 4%"> : </td>
			<td style="width: 47%"> <?= trim($userdata[7]); ?> <!-- TETAP --></td>
		</tr>
        <tr><td style="line-height: 3px;"> </td></tr>
        <tr>
            <td style="width: 4%"> </td>
...
<tr>
    ...
    <td style="width: 4%"> : </td>
    <td style="width: 47%">Pegawai Tetap {{$namaperusahaan}}</td>
</tr>
</table>
...
<tr style="page-break-inside:avoid; page-break-after:auto">
    ...
    <table id="aligncenter" style="width:100%; text-align: center;">
        ...
        <tr>
            ...
            <strong> <u> {{$menyetujui}} <!-- MOCH. YUSUF KURNIAWAN, ST. --> </u> </strong>
            </td>
            <td style="text-align: center; width: 50%; font-family: 'Book Antiqua'; font-size: 12pt;">
            <!-- <strong> {{$pembuatpernyataan}} MOCH. YUSUF KURNIAWAN, ST. </strong> -->
            <strong> <u> {{$namapersonil}} <!-- MOCH. YUSUF KURNIAWAN, ST. --> </u> </strong>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; width: 50%; font-family: 'Book Antiqua'; font-size: 12pt;">
