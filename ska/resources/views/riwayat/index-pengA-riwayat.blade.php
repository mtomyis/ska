    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Riwayat Hidup Pengawasan Air</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box-body col-md-12">
            <div class="box-body col-md-12">
                ...
                <input type="hidden" name="jenispengalaman" value="6">
                <!-- pengawasan air -->
                ...
                <input id="namapersonil" type="text" name="namapersonil" class="form-control" placeholder="Input Nama Personil">
                </div>
                ...
                / <a href="{{ url('/referensi') }}">Buat Referensi</a></p>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input id="pembuatpernyataan" type="text" name="pembuatpernyataan" class="form-control" placeholder="Input Pembuat Pernyataan" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input id="menyetujui" type="text" name="menyetujui" class="form-control" placeholder="Input Menyetujui">
                    </div>
                </div>
                <div class="col-md-6">
                    <div hidden class="form-group">
